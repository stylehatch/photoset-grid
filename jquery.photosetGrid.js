...
;(function ( $, window, document, undefined ) {
    ...
    Plugin.prototype = {
        ...
        init: function() {
            ...
            this._layoutToArray(this.element, this.options);
        ...
        _layoutToArray: function( elem, options ){
        	...
        	for (var i in this.rows ) {
				this.rows[i] = parseInt(this.rows[i]);
			}
        },
        	...
        	var setupStyles = function(){
                ...
                function resizePhotosetGrid(){
                    $rows.each(function(){
                        ...
                        $(this).find('img').each(function(){
                            var marginOffset = ((rowHeight - $(this).height())*.5) + 'px';
                            $(this).css({
